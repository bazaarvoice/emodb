...
// A very thin wrapper for persisting writes to history store, in case audits and compactions go to the same location,
...
public interface HistoryBatchPersister {
