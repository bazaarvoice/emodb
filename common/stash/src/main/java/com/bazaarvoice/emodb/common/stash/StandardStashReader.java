...
public class StandardStashReader extends StashReader {
    ...
    private final Duration _refreshLatestDuration;
    ...
    private String readFirstLineFromS3File(String bucket, String path) {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(s3Object.getObjectContent(), StandardCharsets.UTF_8))) {
            return in.readLine();
        } catch (IOException e) {
