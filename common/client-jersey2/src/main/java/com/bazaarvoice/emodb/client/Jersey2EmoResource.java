 ...
 */
public class Jersey2EmoResource implements EmoResource {

    private static final Logger LOG = LoggerFactory.getLogger(Jersey2EmoResource.class);
    private WebTarget _target;
    private Invocation.Builder _builder;
    private MediaType _type;

    Jersey2EmoResource(WebTarget resource) {
    ...
    private EmoResponse toEmoResponse(Response response) {
        return new Jersey2EmoResponse(response);
    }
