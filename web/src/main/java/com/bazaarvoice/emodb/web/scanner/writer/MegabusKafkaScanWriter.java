...
public class MegabusKafkaScanWriter implements KafkaScanWriter {
    ...
    @Inject
    public MegabusKafkaScanWriter(@Nullable KafkaCluster kafkaCluster, ObjectMapper objectMapper, Clock clock,
