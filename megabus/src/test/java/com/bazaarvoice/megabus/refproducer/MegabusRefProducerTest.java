...
public class MegabusRefProducerTest {
    ...
    public void testPeekAndAckEvents() {
        ...
        assertEquals(argument.getValue().value(), objectMapper.valueToTree(Collections.singletonList((new MegabusRef(tableName, documentId, documentUuid, staticInstant)))) );
