...
*   `PUT` - The body of the request is optional.  If specified, it must be a valid JSON condition string in the format
    generated by `Condition.toString()`.  See the [Conditions] (https://github.com/bazaarvoice/emodb/blob/master/docs/Deltas.md)
...
See the [Conditions] (https://github.com/bazaarvoice/emodb/blob/master/docs/Deltas.md) section of the Delta
