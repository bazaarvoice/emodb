...
For any data item, Emo has three copies of it per data center (this is configurable). It is a dynamo-style database, so none of these are a primary or replica--they are all equal.
