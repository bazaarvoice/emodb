...
public class ResolvedUpdateRefSerializer {
    ...
    public static ByteBuffer toByteBuffer(ResolvedUpdateRef ref) {
    ...
    public static ResolvedUpdateRef fromByteBuffer(ByteBuffer buf) {
        Composite composite = newComposite();
        ...
        String document = (String) composite.get(3);
        ...
        return new ResolvedUpdateRef(new UpdateRef(table, key, changeId, tags), subscriptionNames, document);
    }
