...
public class DefaultDatabusTest {
    ...
    public void testSubscriptionCreation() {
        ...
        DefaultDatabus testDatabus = new DefaultDatabus(
                ...
                new KafkaProducerConfiguration(), new KafkaProducerConfiguration(), new KafkaTopicConfiguration("master-queue"), new KafkaTopicConfiguration("resolver-retry-queue"), new Boolean(false), new Boolean(false), new Boolean(false), "localhost:2181", "localhost:9092",2, "default-application-id", 1, key -> 0, mock(MetricRegistry.class), Clock.systemUTC());
    ...
    public void testDrainQueueForAllNonRedundantItemsInOnePeek() {
        ...
        DefaultDatabus testDatabus = new DefaultDatabus(
                ...
                new KafkaProducerConfiguration(), new KafkaProducerConfiguration(), new KafkaTopicConfiguration("master-queue"), new KafkaTopicConfiguration("resolver-retry-queue"), new Boolean(false), new Boolean(false), new Boolean(false), "localhost:2181", "localhost:9092", 2, "default-application-id",1, key -> 0, new MetricRegistry(), Clock.systemUTC());
    ...
    public void testLazyPollResult() {
        ...
        DefaultDatabus testDatabus = new DefaultDatabus(
                ...
                new KafkaProducerConfiguration(), new KafkaProducerConfiguration(), new KafkaTopicConfiguration("master-queue"), new KafkaTopicConfiguration("resolver-retry-queue"), new Boolean(false), new Boolean(false), new Boolean(false), "localhost:2181", "localhost:9092", 2, "default-application-id",1, key -> 0, new MetricRegistry(), clock);
    ...
    public void testFanoutToMasterPartitions() {
        ...
        DefaultDatabus testDatabus = new DefaultDatabus(
                ...
                new KafkaProducerConfiguration(), new KafkaProducerConfiguration(), new KafkaTopicConfiguration("master-queue"), new KafkaTopicConfiguration("resolver-retry-queue"), new Boolean(false), new Boolean(false), new Boolean(false), "localhost:2181", "localhost:9092", 2, "default-application-id",3, masterPartitioner, new MetricRegistry(), Clock.systemUTC());
