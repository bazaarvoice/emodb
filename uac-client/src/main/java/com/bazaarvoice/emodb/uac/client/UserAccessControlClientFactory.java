...
public class UserAccessControlClientFactory implements MultiThreadedServiceFactory<AuthUserAccessControl> {
     ...
     */
    public static UserAccessControlClientFactory forClusterAndEmoClient(String clusterName, EmoClient client) {
        return new UserAccessControlClientFactory(clusterName, client);
    }

    private UserAccessControlClientFactory(String clusterName, EmoClient emoClient) {
